...
public class giveFlowerOfTruth implements CommandExecutor {
    @Override
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if(player.isOp()) {
            if (cmd.getName().equalsIgnoreCase("givefloweroftruth")) {
                player.getInventory().addItem(itemManager.FlowerOfTruth);
            }
