...
public class giveAspectOfTheEnd implements CommandExecutor {
    @Override
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if(player.isOp()) {
            if (cmd.getName().equalsIgnoreCase("giveaspectoftheend")) {
                player.getInventory().addItem(itemManager.aspectoftheend);
            }
